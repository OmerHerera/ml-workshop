...
# LinearRegression is used to model the relationship between a dependent variable (e.g., house price) and one or more independent variables (e.g., meters footage).
...
model.fit(X, y)
# This makes a prediction for a house that’s 1800 meters.
...
print(model.predict([[1800]]))  # Predict price of 1800 meters house